...
void sendByte (unsigned char byte) {
    if (byte & 0b10000000) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b01000000) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00100000) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00010000) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00001000) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00000100) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00000010) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00000001) { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATFbits.LATF2 = 1; __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop(); LATFbits.LATF2 = 0; __nop(); __nop(); __nop(); __nop();; }
}
