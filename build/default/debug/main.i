...
# 11 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\include\\c99\\inttypes.h" 3
...
# 12 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\include\\c99\\inttypes.h" 2 3
...
# 129 "./mcc_generated_files/system/../timer/tmr0.h"
void TMR0_Stop(void);
# 138 "./mcc_generated_files/system/../timer/tmr0.h"
uint8_t TMR0_Read(void);
# 147 "./mcc_generated_files/system/../timer/tmr0.h"
void TMR0_Write(uint8_t timerVal);
# 156 "./mcc_generated_files/system/../timer/tmr0.h"
...
# 44 "./mcc_generated_files/system/../timer/delay.h"
...
# 42 "./mcc_generated_files/system/../system/interrupt.h"
void (*RC6_InterruptHandler)(void);
void RC6_SetInterruptHandler(void (*InterruptHandler)(void));
void RC6_ISR(void);
# 77 "./mcc_generated_files/system/../system/interrupt.h"
void INTERRUPT_Initialize (void);
# 226 "./mcc_generated_files/system/../system/interrupt.h"
void INT0_ISR(void);
# 235 "./mcc_generated_files/system/../system/interrupt.h"
void INT0_CallBack(void);
# 244 "./mcc_generated_files/system/../system/interrupt.h"
void INT0_SetInterruptHandler(void (* InterruptHandler)(void));
# 254 "./mcc_generated_files/system/../system/interrupt.h"
extern void (*INT0_InterruptHandler)(void);
# 263 "./mcc_generated_files/system/../system/interrupt.h"
void INT0_DefaultInterruptHandler(void);
# 272 "./mcc_generated_files/system/../system/interrupt.h"
void INT1_ISR(void);
# 281 "./mcc_generated_files/system/../system/interrupt.h"
void INT1_CallBack(void);
# 290 "./mcc_generated_files/system/../system/interrupt.h"
...
void init_nrf(){
    ...
    Nrf24_init(&dev);
 Nrf24_config(&dev, 99, 32);


 int ret = Nrf24_setRADDR(&dev, (uint8_t *) "GAME4");
 if (ret != 0) {
  while(1) { DELAY_milliseconds(1); }
 }
    ret = Nrf24_setTADDR(&dev, (uint8_t *) "GAME4");
 if (ret != 0) {
  while(1) { DELAY_milliseconds(1); }
 }
 ...
 Nrf24_printDetails(&dev);
    uint8_t buf[32];
    while(1) {
  if (Nrf24_dataReady(&dev) == 0) break;
  Nrf24_getData(&dev, buf);
 }
}
# 65 "main.c"
void sendByte (unsigned char byte) {
    if (byte & 0b10000000) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b01000000) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00100000) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00010000) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00001000) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00000100) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00000010) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
    if (byte & 0b00000001) { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 1; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; } else { do { LATAbits.LATA0 = 1; } while(0); __nop(); __nop(); __nop(); LATAbits.LATA0 = 0; __nop(); __nop(); __nop(); __nop(); do { LATAbits.LATA0 = 0; } while(0); __nop(); __nop(); __nop(); __nop();; }
}
...
void sendGrid(uint8_t grid[200]){
    int gridSize = 10;
...
void main(void)
{
    ...
    uint8_t gridE[200] = { [0 ... (200 -1)] = 0 };
    uint8_t gridR[200] = { [0 ... (200 -1)] = 1 };
    uint8_t gridG[200] = { [0 ... (200 -1)] = 2 };
    uint8_t gridB[200] = { [0 ... (200 -1)] = 3 };
    sendGrid(gridB);

    uint8_t buf[32] = "wassup";
 while(1) {
